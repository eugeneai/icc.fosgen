...
ext_modules = [
    #    Extension("icc.fosgen.cython_module",
    #              sources=["src/./icc.fosgen/cython_module.pyx"],
    #              libraries=["gdal"],
    #    )
]
...
setup(
    name='icc.fosgen',
    version=version,
    description="Generates some textual data in FOS3+ documents",
    ...
    #     """.split('\n') if c.strip()],
    # ],
    keywords='text generator',
    author='Evgeny Cherkashin',
    author_email='eugeneai@irnok.net',
    url='https://github.com/eugeneai/icc.fosgen',
    license='GPL-3',
    ...
    test_suite='tests',
    entry_points={'console_scripts': ['icc.fosgen=icc.fosgen:main']},
